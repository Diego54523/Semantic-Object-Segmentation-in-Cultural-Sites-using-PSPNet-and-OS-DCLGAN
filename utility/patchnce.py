...
You may choose class PatchNCEloss2 (used in vanilla CUT, no cosine similarity), by replacing line 5 in ./OSUDL_model.py with "from .patchnce import PatchNCELoss2".
"""
